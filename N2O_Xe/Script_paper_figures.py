...
rho_exp =      [0.10, 0.15, 0.37, 0.49, 0.62, 0.66, 0.75, 0.87, 0.93, 1.33, 1.56]
...
exp_fspc = [
    "source/Xe_FTIR/rho0p10.mat",
    "source/Xe_FTIR/rho0p15.mat",
    "source/Xe_FTIR/rho0p37.mat",
    "source/Xe_FTIR/rho0p49.mat",
    "source/Xe_FTIR/rho0p62.mat",
    "source/Xe_FTIR/rho0p66.mat",
    "source/Xe_FTIR/rho0p75.mat",
    "source/Xe_FTIR/rho0p87.mat",
    "source/Xe_FTIR/rho0p93.mat",
    "source/Xe_FTIR/rho1p33.mat",
    "source/Xe_FTIR/rho1p56.mat"]
exp_kspc = [
    "adjyvalues_0p10_norm",
    "adjyvalues_0p15_norm",
    "adjyvalues_0p37_norm",
    "adjyvalues_0p50_norm",
    "adjyvalues_0p62_norm",
    "adjyvalues_0p66_norm",
    "adjyvalues_0p75_norm",
    "adjyvalues_0p78_norm",
    "adjyvalues_0p93_norm",
    "adjyvalues_1p33_norm",
    "adjyvalues_1p56_norm"]
exp_ffrq = "source/Xe_FTIR/xx.mat"
exp_kfrq = "xx"
...
for iv, Vmi in enumerate(Vm):
    ...
    select21s = np.logical_and(
        freq > rnge21s[0], freq < rnge21s[1])
    ...
    # Hot band
    overlap_hotband = 0.6
    scale21 = 1./np.max(avgspec[select21s])*overlap_hotband/overlap
    aux = overlap*avgspec[select21]*scale21
    aux[aux > overlap] = np.nan
    axs2.plot(
        freq[select21], aux + iv, '-', 
        color=color_scheme[iv], label=label)
