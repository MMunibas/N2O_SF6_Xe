    ...
    for ir, idcd in enumerate(iruns):
        ...
        if not os.path.exists(xfile_i) or to_small or to_small_once or False:
            ...
            charges = np.array(
                ...
                + [2.0, -0.333333333, -0.333333333, -0.333333333, -0.333333333, -0.333333333, -0.333333333]*sys_Nres[tag]['SF6'])
            ...
            for ii, frame in enumerate(dcd.trajectory):
                ...
                if cell[0]!=0.0:
                    ...
                    except scipy.io._fortran.FortranEOFError:
                        break
...
for it, Ti in enumerate(T):
    ...
    for iv, Vmi in enumerate(Vm[it]):
        ...
        for ismpl in Smpls[Ti][Vmi]:
            ...
            if not os.path.exists(xfile) or request_appending:
                ...
                if len(tmplst):
                    ...
                    print("Done - {:.3f} ps in total".format(tmax))
